...
dequeue.o: dequeue.c dequeue.h
	$(CC) -c $(CPPFLAGS) $(CFLAGS) -o $@ dequeue.c
...
check:
	...
	do \
	  ...
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c dequeue.c $(LDFLAGS) ) \
	  && ( t/a.out ); \
	done 
...
check-examples:
	...
	do \
	  ...
	  ( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out $$i.c dequeue.c $(LDFLAGS) ) \
...
echeck:
	...
	do \
	  ...
	  echo "Running test $$i ..."; \
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c dequeue.c $(LDFLAGS_EFENCE) ) \
	  && ( LD_PRELOAD=libefence.so ./t/a.out ); \
	done 

indent:
	@indent $(INDENT_FLAGS) dequeue.c
	@indent $(INDENT_FLAGS) dequeue.h
